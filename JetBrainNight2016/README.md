...
[페이스북](https://www.facebook.com/groups/1821879151380372/)에서 일정이 올라온 것을 보고 바로 신청을 하였다.<br/>
...
자바와 스칼라로 어려움을 느꼈던 부분을 해결하기 위해 JetBrains에서 제작한 것이 Kotlin이며,
Kotlin에 대한 간략 소개를 한 시간이다.
...
이 발표는 JetBrains의 제품소개 시간이라고 봐도 되지만,
IDE 작업 중 다른 작업창으로 떠나는 것은 결국 작업의 흐름을 끊는 행위이기 때문에 모든 작업을 IDE에서 할 수 있도록 하는 것이 생산성에 좋다는 것이다.
