...
저런 생각으로 바라볼 수도 있구나란 생각으로 봐주셨으면 함
...
[채용페이지](https://ohmytriptech.github.io/recruit)
...
> 개발자인데 앞으로 어떻게 해야하지, 어떻게 경력을 쌓아야하지, 어떻게 조직을 꾸려야할지 고민인 분들을 위한 회사
...
> 이 부분이 개인적으로 공감이 좀 안됐던 것이 대기업에 가서 전문성을 쌓을 수 있나? 라고 물음표가 가득했습니다.  
...
OKKY를 만드신 정병태님, 삼성 SDS HR 수석보님, 이민석 교수님, 김창준 대표님, 김동수 CTO님, 이규원 CTO님
