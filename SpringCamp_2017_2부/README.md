...
Spring/KSUG를 돌아보는 시간

### 코드를 보며

RowMapperResultSetExractor

* 개수를 명확히 알면 ArrayList, 명확하지 않으면 LinkedList
* 개인적 추측이지만, 받아 쓰는 쪽이 get(i)로 접근하는 경우가 더 많기 때문에 바뀐것같았음
...
* 웹에 있는 많은 자료들 중에서 레거시를 걸러낼려면 현재 사용하는 기술을 잘알아야 한다.
